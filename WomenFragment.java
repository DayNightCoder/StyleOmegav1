...
public class WomenFragment extends Fragment {
   ...
   // private Item_Adapter adapter;
    adapter ad;
    private List<Display_Items> albumList;
...
ProductLogic pl = new ProductLogic();
      ...
      //  cL.cf(this.getActivity(),5);
        ...
        albumList.addAll(db.getProducts());
      //  new Thread(new Runnable() {
        //    @Override
         //   public void run() {
setAdapter(recyclerView,rootView,this.getContext(),albumList);
...
*/
    ...
    public void setAdapter(RecyclerView recyclerView, View rootView, Context context, List <Display_Items> itemsList){
        ...
        RecyclerView.LayoutManager mLayoutManager = new GridLayoutManager(rootView.getContext(), 2);
        recyclerView.setLayoutManager(mLayoutManager);
        recyclerView.addItemDecoration(new WomenFragment.GridSpacingItemDecoration(2, dpToPx(2), true));
        recyclerView.setItemAnimator(new DefaultItemAnimator());
        adapter adapterobj = ad.getInstance(context,itemsList);
